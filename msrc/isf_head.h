      ...
      integer ISF_AUXID_LEN
      integer ISF_GROUPID_LEN
      ...
      parameter (ISF_EVID_LEN=10)
      parameter (ISF_REGION_LEN=64)
      ...
      parameter (ISF_AUXID_LEN=4)
      parameter (ISF_GROUPID_LEN=8)
      ...
      character isf_error*(ISF_LINE_LEN)
      character isf_prev_line_type*(ISF_LINE_LEN)
      common /isf_error/ isf_error
